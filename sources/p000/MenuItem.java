...
public final class MenuItem {
    ...
    public final MenuItem m895e() {
        return m903a(new int[]{16, AppState.getInt(1450)});
    }
        ...
        if (i < i2) {
            if (i5 == 1) {
                ...
                if (i6 < 0 || i6 >= i2) {
                    ...
                    m907a(vector, str, i6 + AppState.getString(i7 + 1141).length(), i2, i3, i4, 1);
                }
            } else if (i5 == 2 || i5 == 3) {
                int i9 = -1;
                int i10 = -1;
                ...
                if (i9 < 0 || i9 >= i2) {
                    ...
                    m907a(vector, str, i9 + AppState.getString(i10 + 1184).length(), i2, i3, i4, 2);
                }
            } else if (i5 == 0) {
                int i12 = -1;
                int i13 = -1;
                ...
                if (i12 < 0 || i12 >= i2) {
                    ...
                    m907a(vector, str, i12 + AppState.getString(i13 + 1063).length(), i2, i3, i4, 0);
                }
    ...
    public final int m910f() {
        ...
        while (true) {
            ...
            iM502a = Utils.max(iM502a, this.f264j[(size << 1) + 1] + m904b(vector.elementAt(size)));
        }
    }
    ...
    public final int m912h() {
        return Utils.max(this.f262h, AppState.getInt(1450)) + 4;
    }
