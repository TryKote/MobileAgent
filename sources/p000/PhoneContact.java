...
public final class PhoneContact implements ListItem, Identifiable {
    ...
    public final String getText() {
        return NetworkUtils.bufToStringCached(NetworkUtils.newStringBuffer().append(AppState.getString(450)).append(this.f167e).append(AppState.getString(447 + Utils.m540f(this.f167e))).append(')'));
    }
