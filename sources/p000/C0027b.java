...
public final class C0027b {
    ...
    public static final long m693e(long j, long j2) {
        ...
        int iM676m2 = iM676m - m676m(j2);
        while (true) {
            int iM503b = AbstractC0019as.m503b(C0015ao.m360b(jM677n) - 1, C0015ao.m360b(j3));
            if (iM503b <= 8) {
                break;
            }
    ...
    private static final long m695b(boolean z, int i, long j) {
        ...
        short s = ((short[]) AbstractC0023aw.f177b[988])[i3];
        int iM360b = C0015ao.m360b(j);
        int i4 = s - iM360b;
        long jM696j = m696j(j << iM360b, ((long[]) AbstractC0023aw.f177b[987])[i3]);
    ...
    public static final long m697a(String str) {
        char cCharAt;
        String strM17c = C0000a.m17c(str.trim().toUpperCase());
        ...
        if (i < length && (((cCharAt = strM17c.charAt(i)) == 'I' || cCharAt == 'i') && C0000a.m6a(AbstractC0023aw.m584b(984), C0000a.m17c(C0000a.m15c(strM17c, i).toUpperCase())))) {
        ...
        if (i + 1 < length && (strM17c.charAt(i) == 'E' || strM17c.charAt(i) == 'e')) {
            i2 += Integer.parseInt(C0000a.m15c(strM17c, i + 1));
        } else if (i != length) {
            throw new NumberFormatException(strM17c);
        }
    ...
    public static final String m698a(long j, int i) {
        ...
        if (m680p(j)) {
            return AbstractC0023aw.m584b(zM675l ? 985 : 984);
        }
        if (i < 9) {
            i = 9;
        }
        ...
        int i3 = iM676m / 11;
        int i4 = ((short[]) AbstractC0023aw.f177b[989])[i3];
        while (jM677n <= 922337203685477580L) {
            jM677n = (jM677n << 3) + (jM677n << 1);
            i4--;
        }
        long jM696j = m696j(jM677n, ((long[]) AbstractC0023aw.f177b[986])[i3]);
        boolean z2 = false;
        while (true) {
    ...
    */
    private static int m711a(long j, long[] jArr) {
        ...
        if (i3 <= 1094263291) {
            ...
            if (iM688c2 < 32) {
                if (i3 != ((int[]) AbstractC0023aw.f177b[993])[iM688c2 - 1]) {
        ...
        for (int i32 = i17; i32 >= 0; i32--) {
            ...
            for (int i33 = 0; i33 <= 4 && i33 <= i17 - i32; i33++) {
                jM690b5 = m690b(jM690b5, m692d(((long[]) AbstractC0023aw.f177b[990])[i33], jArr4[i32 + i33]));
            }
