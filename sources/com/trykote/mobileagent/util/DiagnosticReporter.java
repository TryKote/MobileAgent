...
public abstract class DiagnosticReporter {
    ...
    public static final void checkCrashReport() {
        ...
        if (jCurrentTimeMillis > SessionState.getTimestampLastCleanup() + CLEANUP_INTERVAL_MS) {
            SessionState.setTimestampLastCleanup(jCurrentTimeMillis);
