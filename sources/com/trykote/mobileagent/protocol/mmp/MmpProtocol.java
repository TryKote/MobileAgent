            ...
            if (packet.peekByteAt(1) == MmpCommand.PACKET_COMMAND) {
                ...
                switch (commandId) {
                    ...
                    case MmpCommand.AUTH_RECEIVED:
                        ...
                        onMessage(senderId, 0L, ObjectPool.toStringAndRelease(ObjectPool.newStringBuffer().append(Storage.resources().getString(StringResKeys.STR_MMP_FILE_TRANSFER)).append(Storage.state().getString(authFlag == 1 ? 484 : 485)).append(packet.readVarLenStr())));
        ...
        switch (((Integer) objArr[1]).intValue()) {
            ...
            case 7:
                ...
                if (buf.readShortLE() == 2010) {
                    ...
                    buf.readByte();
                    ContactInfo contactInfo = (ContactInfo) Storage.state().getObject(RegistrationKeys.SLOT_REG_PARAM_2);
